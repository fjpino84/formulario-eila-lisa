...
export const CHALLENGE_OPTIONS: ChallengeOption[] = [
  { id: "numero_boleta", label: "El número de boleta es sospechoso", correct: true },
  { id: "monto_boleta", label: "El monto de la boleta es sospechoso", correct: true },
  { id: "nombre_beneficiario", label: "El nombre del beneficiario es sospechoso", correct: false },
